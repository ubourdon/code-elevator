angular.module('elevatorApp', ['ngCookies', 'md5', 'ui-gravatar', 'elevatorApp.services'], function ($routeProvider) {
    $routeProvider.
        when('/', {templateUrl: '/assets/partials/elevator.html', controller: ElevatorCtrl}).
        when('/leaderboard', {templateUrl: '/assets/partials/leaderboard.html', controller: LeaderboardCtrl}).
        when('/administration', {templateUrl: '/assets/partials/administration.html', controller: AdministrationCtrl}).
    ...
    .directive('building', function () {
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                imageObj.src = '/assets/images/man.png'
